...
entity control_path is
    port (
        ...
        rename_is_jump_o        : out std_logic;    -- needed ?
...
begin
    ...
    begin
        if rising_edge(clk) then
            if reset = '0' then
                ...
                rename_is_jump_s       <= decode_is_jump_s;
            end if;
        end if;
    end process;
    ...
    mem_subtype_s    <=  SB  when (dipatch_instr_type_s = STORE and dipatch_funct3_s = "000") else
    ...
    process (rob_full_i, free_list_fifo_empty_i, rename_rd_we_s, iq_full_i, rs_full_i) is
    begin
        stall_if_o <= '0';
        stall_id_o <= '0';
        stall_rn_s <= '0';
