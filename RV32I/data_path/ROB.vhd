    ...
    begin
        if (rising_edge(clk)) then
            if (reset = '0') then
                head    <= 0;
                tail    <= 0;
                rob     <=  (others => (valid => '0', ready => '0', rd_instr => '0', is_branch => '0', others => (others => '0')));
                ...
                -- Rename stage
                if rob_write_en_i = '1' and rob_full_s = '0' and rename_fifo_empty_i = '0' and rob(tail).valid = '0' then
                    rob(tail).valid     <= '1';
                    rob(tail).ready     <= '0';
                ...
                -- Commit stage
                if rob(head).valid = '1' and rob(head).ready = '1' then
                    commit_valid_o      <= '1';
                    commit_pc_valid_o   <= '0';
